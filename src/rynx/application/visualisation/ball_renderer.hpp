		...
		namespace visualisation {
			struct ball_renderer : public rynx::application::renderer::irenderer {
				...
				virtual void render(const rynx::ecs& ecs) override {
					...
					ecs.query().notIn<rynx::components::boundary, rynx::components::mesh>().execute([this](const rynx::components::position& pos, const rynx::components::radius& r, const rynx::components::color& color) {
						matrix4 model;
