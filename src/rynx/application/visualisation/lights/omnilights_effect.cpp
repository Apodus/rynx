...
rynx::application::visualisation::omnilights_effect::omnilights_effect(
  ...
  m_lights_shader =
      shader_manager->load_shader("fbo_lights", "/shaders/screenspace.vs.glsl",
                                  "/shaders/screenspace_lights.fs.glsl");

  m_lights_shadow_shader = shader_manager->load_shader(
      "fbo_lights_shadows", "/shaders/screenspace.vs.glsl",
      "/shaders/screenspace_lights_shadows.fs.glsl");
...
void rynx::application::visualisation::omnilights_effect::prepare(
  ...
  ctx->add_task("lights prepare", [this](rynx::ecs &ecs) {
    ecs.query().notIn<rynx::components::graphics::frustum_culled>().for_each(
        [this](const rynx::components::transform::position &pos,
          ...
          m_light_settings.emplace_back(0.0f, light.attenuation_linear,
