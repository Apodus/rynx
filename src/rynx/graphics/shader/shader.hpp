...
public:
  shader(rynx::string name, const char *vertexSource,
         const char *fragmentSource);
  shader(rynx::string name, const char *vertexSource,
         const char *fragmentSource, const char *geometrySource, GLint input,
  ...
  shader &uniform(const rynx::string &name, vec3f v) {
    return uniform(name, v.x, v.y, v.z);
  }
  shader &uniform(const rynx::string &name, floats4 v) {
  ...
  GLint attribute_optional(const rynx::string &name);
