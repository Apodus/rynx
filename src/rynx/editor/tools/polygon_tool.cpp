...
rynx::editor::tools::polygon_tool::polygon_tool(rynx::scheduler::context& ctx) {
	...
	define_action_no_tool_activate(rynx::traits::type_name<rynx::components::boundary>(), "vertices smooth", [this](rynx::scheduler::context* ctx) {
		action_smooth(ctx->get_resource<rynx::ecs>());
	});

	define_action_no_tool_activate(rynx::traits::type_name<rynx::components::boundary>(), "mesh rebuild", [this](rynx::scheduler::context* ctx) {
		action_rebuild_mesh(ctx->get_resource<rynx::ecs>(), ctx->get_resource<rynx::graphics::mesh_collection>());
	});
	
	define_action_no_tool_activate(rynx::traits::type_name<rynx::components::boundary>(), "mesh rebuild boundary", [this](rynx::scheduler::context* ctx) {
	...
	define_action_no_tool_activate(rynx::traits::type_name<rynx::components::boundary>(), "opimize bounding sphere", [this](rynx::scheduler::context* ctx) {
...
{
	auto entity = ecs[id];
	if (!entity.has<rynx::components::boundary, rynx::components::position, rynx::components::radius>())
		return;
